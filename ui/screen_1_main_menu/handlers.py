...
from ui.screen_0_start_menu.keyboard import get_screen_1_main_menu_keyboard
from ui.screen_0_start_menu.texts import get_main_text
...
def show_screen_1_main_menu(chat_id: int, state: StateContext):
    ...
    bot.send_message(
        chat_id,
        get_main_text(),
        reply_markup=get_screen_1_main_menu_keyboard(),
    )
