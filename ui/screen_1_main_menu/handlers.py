...
from ui.screen_1_main_menu.texts import get_text_screen_2_input_date, get_text_screen_8_old_travel,get_error_text_screen_8
...
def callback_screen_8_old_travel(call: types.CallbackQuery, state: StateContext):
    ...
    try:
        ...
        try:
            ...
            bot.send_message(chat_id, get_error_text_screen_8())
